...
class ItemEtapaQuantizadaClivagem extends StatelessWidget {
  ItemEtapaQuantizadaClivagem({Key? key, this.etapa, this.protocoloModel, this.onTapDelete, this.onTapEdit}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  etapa!.tipo_quant == "1" ?
                  Text("Nome: " + etapa!.desc_residuo!, style: const TextStyle(color: Colors.white, fontSize: 20)):
